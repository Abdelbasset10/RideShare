...
const { createTrajet, reserverTrajet, getCloseTrajets, getAllTrajets, getTrajet, updateTrajet, deleteTrajet, getUserTrajets, searchTrajet} = require("../controllers/trajet");
