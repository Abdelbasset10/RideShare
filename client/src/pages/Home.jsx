                    ...
                    <div className="explanations-steps-wrapper">
                        ...
                        <div className="step step-1">
                            ...
                            <div className="step-1-text">
                                <h3>Vous n'avez pas trouvé de covoiturage pour votre destination à la date que vous souhaitez ?</h3>
                                <p>Partagez vos besoins de voyage en publiant une demande sur RideShare. Indiquez votre destination, la date et d'autres préférences pour trouver le trajet parfait.</p>
                            </div>
                        </div>
                        ...
                        <div className="step step-2">
                            ...
                            <div className="step-2-text">
                                ...
                                <p>Découvrez une liste de Trajets qui correspondent à votre demande. Consultez leurs details, et choisissez celui qui correspond le mieux à vos critères.</p>
                            </div>
                        ...
                        <div className="step step-1">
                            ...
                            <div className="step-3-text">
                                <h3>Sélectionnez le covoiturage parfait et préparez-vous pour un voyage inoubliable</h3>
                                <p>Explorez les trajets proposés, choisissez celui qui vous convient le mieux , reservez votre place et préparez-vous pour un voyage sans souci. C'est la clé pour une expérience de voyage personnalisée.</p>
                            </div>
                        </div>
                    </div>
